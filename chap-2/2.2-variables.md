...
Il s'agit de la direction du symbole par rapport aux directions de la base de la carte (bords verticaux et horizontaux du cadre). Quatre directions principales sont donc possibles : verticale, horizontale et deux obliques à 45 %, les autres orientation sont plus difficile à distinguer. L'orientation permet de différencier les qualités des objets géographiques.
