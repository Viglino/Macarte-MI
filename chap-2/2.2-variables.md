...
| ![](/Macarte-MI/assets/img/ch2.2-form1.png) <br/> ![](/Macarte-MI/assets/img/ch2.2-form2.png) | ![](/Macarte-MI/assets/img/ch2.2-form3.png) |
|:----:|:----:|
...
La forme géométrique va imposer une relation de similitude : toutes les représentation entourées d'un rond seront associées et différentiées par rapport à celles entourées d'un carré et la forme symbolique permettra de faire une différentiation parmis ces représentations entre elles.
