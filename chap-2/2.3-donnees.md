...
Les couches de référence ou de dessin sont disponible dans le gestionnaire de couche (pour en modifer l'ordre d'affichage, la visibilité ou la transparence par exemple). Elles sont parfois appélé "calque" par analogie avec le papier calque qu'on superpose entre eux, dans un processus de reproduction, pour former une image.
