...
Si on peut saisir à la main dans les éditeurs cartographique, la question qui se pose assez rapidement est « Où trouver des données ? »   
...
A l'inverse, vous pouvez exporter les données saisies dans Ma carte dans le dialogue de configuration la couche (<i class="fa fa-cog"></i> dans le gestionnaire de calques) et en cliquant sur l'icone d'export <i class="fa fa-download"></i>.
