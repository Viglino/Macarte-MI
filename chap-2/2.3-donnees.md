...
Elle contient une information liée à sa position sur le globe (ou plus généralement dans l'espace) : sa **géométrie** et des informations descriptives sémantiques qui indique sa nature, son aspect, ses propriétés, etc. On parle d'**attributs**.   
...
[Ma carte](https://macarte.ign.fr/) propose un [outil de géocodage](https://macarte.ign.fr/edition/adresses/) qui va permettre de rechercher la position d'une adresse pour l'ajouter aux données issue d'un fichier attributaire.
...
{: .note }
L'outil de [Ma carte](https://macarte.ign.fr/edition/adresses/) ne permet que de traiter des adresse situées en France... 
