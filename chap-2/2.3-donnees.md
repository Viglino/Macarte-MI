...
Lors d'un glisser-déposer dans l'éditeur de ce type de ficher, vous pouvez recharger toute la carte ou seulement une couche ou la légende ou la bibliothèque de symbole.
...
Ma carte propose un [outil de géocodage](https://macarte.ign.fr/edition/adresses/) qui va permettre de rechercher la position d'une adresse pour l'ajouter aux données issue d'un fichier attributaire.
...
L'outil de Ma carte permet de lister et corriger manuellement les adresses trouvées en proposant une qualité de géocodage et des adresses alternatives lorsqu'il y a ambiguïté.
