...
De manière générale, outre la carte, on retrouve génralement un titre, l'échelle, la légende, auquels il faut ajouter les sources et l'éditeur (affiché via le bouton `i`{: .square } sur Ma carte).
