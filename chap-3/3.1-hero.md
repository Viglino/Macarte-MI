---
layout: default
title: La carte dont vous êtes le héro
...
A l'heure d'internet, la carte intègre un récit, des images, des vidéos, du son. Elle bouge, s'anime, devient interactive. Le lecteur n'est plus seulement lecteur, il devient acteur. Puis il devient lui-même cartographe. La carte n'est plus statique, elle est **narrative**.   
...
Cette phase se sépare en deux parties : la rédaction des cartes et de leur contenu (les données) et la mise en forme de l'histoire (la forme).
...
La première partie va consister à **définir les cartes** utilisées dans le récit, la rédaction des données, la répartition dans les couches, le formatage des l'information qu'elles contiennent, leur symbolisation.
...
{: .center .shadow }
![](/assets//img/ch3.1-share.png)   
Interface de partage de Ma carte

{: .center .shadow }
![](/assets//img/ch3.1-share2.jpg)   
