...
Afin de mettre en évidence un phénomène spatial, la symbologie graphique ne suffit pas et il faut introduire une modélisation graphique supplémentaire pour **servir efficacement à l'interprétation** et à la représentation des espaces, **distributions et dynamiques géographiques**.
...
Ainsi, représenter un ensemble de points sur une carte ne vas pas forcément être représentatif de la densité ou l'amplitude du phénomène observé, les points venant se superposer, ceux du dessous ne seront plus visibles à toutes les échelles. Il va falloir définir une nouvelle modélisation de l'espace permettant de mieux appréhender le message de la carte.

{: .banner }
<iframe src="https://macarte.ign.fr/carte/de31fcce7a144d3ba66ace4ff44b829a/carte?lon=1.47&lat=46.6183783&z=6&noZoom" width="100%" height="450px"></iframe>

{: .figure }
Répartition en cluster pour la fête de la science 2019

Si la formalisation du modèle et l'analyse d'une distribution spatiale peut être rapidement compliqué, certains cas pratique sont apparus sur le géoweb.   
Parmi ceux-ci on trouve des collecteurs (carroyage ou maillage du térritoire) qui vont aggréger une variable dans une surface, les clusters (regroupement et aggrégation d'une valeur sur un points), les cartes de chaleur, les isochrones qui vont permettre de mettre en évidence la distribution et la dynamique spatiale du phénomène observé pour le lecteur.
...
Les cartes de flux utilisent généralement une largeur de ligne proportionnelle à la quantité de flux ([carte symbole proportionnel](https://viglino.github.io/Macarte-MI/chap-1/1.2-classification.html#carte-de-symboles-proportionnels)).
...
Si les premières sont assez faciles à réaliser (il suffit de charger la situation initiale), les secondes nécessite l'accès à la donnée via des API pas toujours standardisée pour fonctionner.

<iframe src="https://macarte.ign.fr/carte/UbsNm6/carte?noZoom" width="100%" height="450px"></iframe>
