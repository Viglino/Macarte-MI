...
Les cartes topographique, du grec topos (τόπος), *lieu* et graphein (γράφειν), *dessiner*, sont des cartes sur lesquelles figurent essentiellement les formes et détails du terrain, qu'ils soient naturels (notamment l'hydrographie et le relief, via les courbes de niveau, les points cotés ou l'estompage) ou artificiels (les constructions, les routes, etc.).  
...
C'est une carte en aplat de couleur en fonction d'un attribut de tout type.	Dans ce cas, ce sont les valeurs d'un attribut qui serviront à coder la couleur.  
